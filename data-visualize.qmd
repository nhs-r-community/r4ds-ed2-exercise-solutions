...
When deciding which data is plotted on the y the [suggestion](https://sciencing.com/proper-way-label-graph-5195234.html) is often to put the first on the y. The following could be either way but it does make it easier to read the species names if they are on the y axis.
